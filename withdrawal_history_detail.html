		...
		<div class="row navi">
			<div class="col-lg-3">
				<ul class="navi__list">
					...
					<li class="navi__item-1">
						<a href="buy_phone_card.php" class="navi__item-2 btn" type="submit"><i class="fa-solid fa-pager"></i> Buy phone
							card</a>
					</li>
					<li class="navi__item-1">
			...
			<div class="col-lg-9">
				<div class="content">
					<!-- Withdraw History -->
					<div class="content_history--withdraw text-center">
						<h2 class="text-center text-light mt-4">Withdraw history</h2>
