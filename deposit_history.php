	...
	<div class="header">
		...
		<div class="dropdown">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				<a class="dropdown-item" href="../e_wallet-start/reset_password.php"><i class="fa-solid fa-key mr-2"></i> Change password
				</a>
				<a class="dropdown-item" href="../e_wallet-start/logout.php"><i class="fa-solid fa-arrow-right-from-bracket mr-2"></i> Logout
				</a>
			</div>
		</div>
		<div class="dropleft">
	...
	<div class="container-fluid">
		<div class="row navi">
				...
				<ul class="navi__list">
					...
					<li class="navi__item-1">
						<a href="withdrawal.php" class="navi__item-2 btn" type="submit">
							<i class="fa-solid fa-money-bill"></i> Withdraw</a>
					</li>
					<li class="navi__item-1">
					...
					<li class="navi__item-1">
						<a href="buy_phone_card.php" class="navi__item-2 btn" type="submit"><i class="fa-solid fa-pager"></i> Buy phone card</a>
					</li>
					<li class="navi__item-1">
			...
			<div class="col-lg-9">
				<div class="content">
					<!-- Deposit History -->
					<div class="content_history--deposit text-center">
						<h2 class="text-center text-light">Deposit history</h2>
						<table class="table text-light">
							...
							<tbody>
								<?php
								if (get_history_deposit($_SESSION["username"]) != 0) {
									$history_deposit = get_history_deposit($_SESSION["username"]);

									foreach ($history_deposit as $deposit) {
								?>
										<tr>
											<th><?= $deposit["TransactionCode"] ?: "" ?></th>
											<td><?= $deposit["ExecutionTime"] ?: "" ?></td>
											<td><?= $deposit["TransactionStatus"] ?: "" ?></td>
											<td><?= number_format($deposit["TransactionMoney"]) . ' VND' ?: "" ?></td>
											<td><?= $deposit["CreditId"] ?: "" ?></td>
										</tr>
								<?php
									}
								}
						...
						<a href="transaction_history.php" class="btn btn-light" type="submit"><i class="fa-solid fa-arrow-left"></i> Go back
						</a>
					</div>
				</div>
			</div>
